...
const definition = {
    ...
    completeUrl: {
        doc: 'The URL (specified during the OAuth 2.0 authorization flow) that the `complete` handler is hosted at.',
        default: null,
        format: String,
        env: 'COMPLETE_URL',
    },
    adminPanelUrl: {
        doc: 'The URL of the admin panel to link the user back to in case something goes horribly wrong.',
        default: '',
        format: String,
        env: 'ADMIN_PANEL_URL',
    },
